...
public class Terminal_Patch
{
    ...
    public static class Terminal_InitTerminal_Patch
    {
        ...
        {
            if (Terminal.commands.ContainsKey("printseeds"))
            {
                Terminal.commands.Remove("printseeds");
            }
            
            Terminal.ConsoleCommand customPrintSeedsCommand = new Terminal.ConsoleCommand("printseeds", "print seeds of loaded dungeons without seed values", (Terminal.ConsoleEventFailable) (args =>
            {
            ...
            Terminal.commands.Add("printseeds",customPrintSeedsCommand);
        }
    }
